...
This document contains the review report for the VersionMark project.
...
conducted for VersionMark remain valid for the current state of the reviewed files.
